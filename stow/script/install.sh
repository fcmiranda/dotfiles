...
INSTALL_DIR="$DOTFILES_STOW_DIR/home/.local"
TARGET_LINK_DIR="$DOTFILES_STOW_DIR/home"
...
chmod +x "$DOTFILES_STOW_DIR/script/link.sh"

echo "Create the .stowrc file and write the content"
echo "--target=$HOME" > $TARGET_LINK_DIR/.stowrc

printf "...\n...\n...\n"
echo "Creating symbolic links from $TARGET_LINK_DIR to $HOME..."
sh "$DOTFILES_STOW_DIR/script/link.sh" $TARGET_LINK_DIR 
